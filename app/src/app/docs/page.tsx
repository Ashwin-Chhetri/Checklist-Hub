        ...
        <section className="py-12 md:py-16">
          <div className="w-full px-xl max-w-6xl mx-auto flex flex-col md:flex-row gap-xl md:gap-2xl items-start">
            ...
            <div className="flex-1 min-w-0 max-w-3xl">
              ...
              <section
                id="citing-checklist-hub"
                className="py-10 md:py-12 border-t border-b border-outline-variant"
              >
                <h2 className="font-headline-md text-[22px] uppercase tracking-tight mb-8">
...
{`@software{checklisthub2026,
  ...
  url     = {https://checklisthub.in}
              ...
              <section id="faq" className="py-10 md:py-12 border-t border-outline-variant">
                <h2 className="font-headline-md text-[22px] uppercase tracking-tight mb-8">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: "https://checklisthub.in/docs#citing-checklist-hub",
          }),
        }}
      />
