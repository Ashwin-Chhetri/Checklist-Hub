  ...
  return (
    <div className="relative flex h-auto min-h-screen w-full flex-col bg-surface-container-low">
      <div className="layout-container flex h-full grow flex-col">
        ...
        <main className="flex-1 flex flex-col py-6 md:py-10 px-md md:px-xl w-full">
          ...
          <div className="w-full md:hidden flex flex-col gap-md">
            {isLoading && (
              <div className="px-6 py-10 text-center text-on-surface-variant bg-surface border border-outline-variant">
                Loading checklists...
              </div>
            )}
            ...
            {visibleChecklists?.map((checklist) => (
              <div
                ...
                className="bg-surface border border-outline-variant p-4 flex flex-col gap-3 cursor-pointer active:bg-surface-container-low transition-colors"
              >
                <div className="flex items-start justify-between gap-2">
                  <div className="flex flex-col gap-1 min-w-0">
                    <span className="font-headline-md text-[17px] tracking-tight leading-tight text-on-surface font-bold truncate">
                      {checklist.title}
                    </span>
                    <span className="font-code-md text-[12px] tracking-tight text-secondary truncate">
                ...
                {checklist.status !== "published" && checklist.has_metadata && (
                  <div className="flex items-center gap-2 border-t border-dashed border-outline-variant pt-2">
                    ...
                    <span className="font-code-md text-[11px] text-on-surface-variant">
                      ...
                      <span className="font-bold text-on-surface">
                        {checklist.species_count.toLocaleString()} species
                      </span>
                    </span>
                  </div>
                )}
                ...
                {checklist.status === "reviewing" && checklist.ipt_submitted_at && (
                  <div className="flex items-center gap-2 border-t border-dashed border-outline-variant pt-2">
                    ...
                    <span className="font-code-md text-[11px] text-on-surface-variant">
                      Submitted to IPT {formatRelativeTime(checklist.ipt_submitted_at)} — awaiting GBIF registration
                    </span>
                  </div>
                )}
              </div>
