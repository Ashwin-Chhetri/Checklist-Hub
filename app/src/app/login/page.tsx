...
export default function LoginPage() {
  ...
  const error = signInWithEmail.error ?? signUpWithEmail.error ?? signInWithProvider.error;
  const isPending =
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (mode === "sign_in") {
      ...
      signUpWithEmail.mutate(
        { email, password },
        { onSuccess: () => setSignUpMessage("Check your email to confirm your account.") },
      );
    }
  }
  ...
  return (
    <div data-modal="true">
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-gutter overflow-y-auto">
        <div className="w-full max-w-[440px] bg-white border border-outline-variant p-xl hard-shadow my-auto">
          ...
          <form className="flex flex-col gap-lg" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-1">
              <div className="flex justify-between items-baseline">
                ...
                {mode === "sign_in" && (
                  <a className="text-base text-primary hover:underline" href="#">
                    Forgot password?
                  </a>
                )}
              </div>
